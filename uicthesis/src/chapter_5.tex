...
Table~\ref{tab:shap} presents the SHAP global feature importance values computed on the log-odds output space~\cite{kamolov2025}.
...
Both SHAP and LIME agree that \textbf{education-num} is among the most important features, and both identify \textbf{age} as a significant protected attribute with measurable influence. This cross-method agreement provides high confidence in the feature attribution findings~\cite{wang2024}.
