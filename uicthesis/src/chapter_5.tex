...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{0.5cm}
    \textbf{[INSERT FIGURE: Group Fairness Comparison Charts]}\\[0.3cm]
    \textit{Grouped bar charts showing positive prediction rate, TPR, and FPR comparisons between Group A and Group B for each protected attribute (sex, age, race, native-country).}
    \vspace{0.5cm}}}
...
\textbf{Layer 2} (32 neurons) is identified as the most bias-sensitive layer with a sensitivity score of 1.933, indicating that this layer amplifies protected attribute information most strongly. Bias concentrated in early-to-middle layers suggests the network encodes protected information during initial feature transformation before it propagates through deeper layers.

\begin{figure}[H]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{0.5cm}
    \textbf{[INSERT FIGURE: Layer Sensitivity Bar Chart]}\\[0.3cm]
    \textit{Bar chart showing sensitivity scores for all 6 layers, with Layer 2 highlighted as the most sensitive.}
    \vspace{0.5cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{0.5cm}
    \textbf{[INSERT FIGURE: Neuron Impact Bar Chart]}\\[0.3cm]
    \textit{Bar chart showing the impact scores of the top 5 neurons in Layer 2.}
    \vspace{0.5cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{0.5cm}
    \textbf{[INSERT FIGURE: SHAP and LIME Feature Importance Charts]}\\[0.3cm]
    \textit{Side-by-side bar charts showing SHAP global feature importance (left) and LIME aggregated importance (right), with protected attributes highlighted in red/orange.}
    \vspace{0.5cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{0.5cm}
    \textbf{[INSERT FIGURE: Fairness Score Gauge]}\\[0.3cm]
    \textit{Screenshot of the Plotly.js gauge chart showing the score of approximately 41, with the needle in the red ``Concerning'' zone.}
    \vspace{0.5cm}}}
