...
\begin{figure}[H]
    ...
    \textbf{[INSERT FIGURE: VS Code Extension Screenshot]}\\[0.3cm]
    \textit{Screenshot showing the right-click context menu on a CSV file with ``FairLint-DL: Analyze This Dataset'' and ``FairLint-DL: Analyze Dataset (Force Retrain)'' options.}
    \vspace{0.5cm}}}
