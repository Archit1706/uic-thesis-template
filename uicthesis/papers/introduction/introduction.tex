...
Keep all your bibtex in `bibphd.bib' file in the `sources' folder. Unique identifier is needed \eg, \verb|\cite{grant2014cvx, einstein1905zur}| \cite{grant2014cvx, einstein1905zur} .
...
\begin{figure}[t]
	...
	\caption{A generic example figure}\label{\CHID_fig:exmple_image}
\end{figure}
